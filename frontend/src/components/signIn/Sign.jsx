          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm sm:text-sm text-slate-500">
              {isSignUp
                ...
                : "Access your streaming catalog"}
            </p>
            <div>
              {error && (
                <div className="bg-red-500/20 border border-red-500/30 text-red-500 p-3.5 rounded-xl text-xs font-semibold text-center">
                  ⚡{error}
                </div>
              )}
              ...
              {success && (
                <div className="bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 p-3.5 rounded-xl text-xs font-semibold text-center">
                  🎉{" "}
                  {isSignUp
                    ? "Registration successful! Directing to Sign In..."
